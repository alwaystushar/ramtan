...
export default function EventsFourth() {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 left-0 lg:w-[32vw] w-[100vw] h-[100vh] bg-[#2b52cf] mix-blend-overlay
 z-0"
        style={{
      ...
      ></div>
        ...
        <div className="absolute lg:bottom-[10vw] bottom-[40vw] lg:left-[2vw] left-[6vw]  ">
            <div className="flex flex-col lg:gap-[1vw] gap-[4vw]">
              ...
              <MotionFadeUp>
                                <p className="lg:text-[0.75vw]  lg:max-w-[22.2vw] max-w-[80vw] text-[3vw] font-light leading-[150%]">
