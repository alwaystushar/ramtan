  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex justify-center py-[1vw] bg-[var(--blue)]">
        {/* Background Text */}
        <div className="relative z-[1] text-[#283a9c] bg-[var(--blue)] lg:text-[5.3vw] text-[8.95vw] leading-[110%] text-start pointer-events-none">
          <p>
        ...
        <motion.div
          className="absolute top-0 left-0 w-full h-full flex items-center justify-center text-start lg:text-[5.3vw] text-[8.95vw] leading-[110%] text-white bg-[var(--blue)] z-[2] pointer-events-none"
          style={{
